...
When we ran the Light GBM model, we improved ROC-AUC curve to 0.754, which is plotted below. This improved the chance of classifying successful movies as successful by about 10%. The accuracy is 0.704 and precision is 0.703, which improved by about 7% when compared to the random forest model.
